			...
			<Dialog.Root>
				...
				<Dialog.Content>
					<Dialog.Header>
						...
						<Dialog.Description
							>This action cannot be undone. This will permanently delete your list and its content,
							including metadata such as likes, saves, and views.</Dialog.Description
						>
					</Dialog.Header>
